...
# simple script for building the ifort-intel-2021.4.0-dev image.

# NOTE: this builds the ifort-intel-2021.4.0 image as well, since there was not
...
podman build \
    ...
    -t ifort-intel-2021.4.0 \
    ../ifort-classic+intel-mpi+oneAPI_base

# build the ifort-intel-2021.4.0-dev image.
podman build \
    --build-arg NUMBER_JOBS=${NUMBER_CORES} \
    --build-arg BASE_IMAGE=ifort-intel-2021.4.0 \
    -t ifort-intel-2021.4.0-dev \
    ../development
